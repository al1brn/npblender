    ...
    def read_term(self, math_mode, styles):
        ...
        while dct is None:
            ...
            # ---------------------------------------------------------------------------
                ...
                elif token.value in SPACES:
                    return {'type': 'SYMBOL', 'string': ' ', 'width': SPACES[token.value]}
        ...
        while True:
            ...
            # ---------------------------------------------------------------------------
                ...
                if ch.value == '\\':
                    ...
                    # --------------------------------------------------
                    # Space (intermediary token)
                    # --------------------------------------------------

                    elif c.value in SPACES:
                        return Token.control(c, None)
