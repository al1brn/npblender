...
from npblender.core.cached_array import CachedArray
from npblender.core.camera import Camera
from npblender.core import attributes
...
class BinGrid:
    ...
    def to_object(self, obj, uv_scale=1, collection=None):
        ...
        obj = blender.create_mesh_object(obj, collection=collection)
