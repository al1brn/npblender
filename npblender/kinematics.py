...
class Kinematics(Simulation):
    ...
    @property
    def ignore_acc(self):
        """ > Ignore acceleration for this selection
    ...
    def compute(self):
        ...
        #self.points.position += self.points.speed*self.delta_time
    ...
    def get_animation(self):
        return {name: self.points.attributes[name] for name in self.points.attributes.names}

    def set_animation(self, data):
        for name, value in data.items():
            self.points.attributes[name] = value
