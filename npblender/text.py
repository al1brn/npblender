...
class Text:
    ...
    def to_mesh_object(self, spec, collection=None, **kwargs):

        mesh_object = blender.create_mesh_object(spec, collection=collection)
        old_data = mesh_object.data

        obj = self.to_object("npblender Temp Text")
    ...
    def to_mesh(self, **kwargs):
        ...
        obj = self.to_mesh_object("npblender Temp Mesh")
